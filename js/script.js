...
// Modal Buttons
const openModalBtns = document.querySelectorAll(".open-trivia-btn");
const triviaModal = document.getElementById("triviaModal");
const closeTriviaModalBtn = document.getElementById("closeTriviaModalBtn");
...
// Close budget modal
closeTriviaModalBtn.addEventListener("click", () => {
  triviaModal.style.display = "none";
  budgetForm.reset();
});
triviaModalOverlay.addEventListener("click", () => {
  triviaModal.style.display = "none";
  budgetForm.reset();
});
